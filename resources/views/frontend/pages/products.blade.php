...
@section('custom-scripts')
    <script> const products = {!! json_encode($products->toArray()) !!}
        ...
        function removeFromCart(id){
            let item = products.find( (el) => { return  el.id == id } );
            productsInCart = productsInCart.filter(function( obj ) {
                return obj.id !== item.id;
            });
            order = order.filter(function( obj ) {
                return obj.id !== item.id;
            });
            $('#cartItemContainer'+item.id).remove();
        }
        ...
        $(document).ready(function(){
            ...
            $(document).bind('addThisProductToCart', function(e, obj) {
                ...
                if(item !== undefined && item !== 'undefined' && !inCart)
                {
                 ...
                 <div class="ibox-content" id="cartItemContainer${item.id}">
                            ...
                            <table class="table shoping-cart-table">
                                ...
                                <tr>
                                    ...
                                    <td class="desc">
                                        ...
                                        <div class="m-t-sm">
                                            <button type="button" class="btn btn-outline btn-secondary btn-xs" onClick="removeFromCart(${item.id})" >
