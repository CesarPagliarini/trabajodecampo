                       ...
                       @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="i-checks"><label> <input type="radio" value="1" name="state" @if(($module->state)==1) checked="" @endif> <i></i> Activo </label></div>
                            </div>
                            <div class="col-sm-3">
                                <div class="i-checks"><label> <input type="radio" value="0" name="state" @if(($module->state)==0) checked="" @endif > <i></i> Inactivo </label></div>
                            </div>
                        </div>
